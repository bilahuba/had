// had_01.cpp : Defines the entry point for the application.
//
...
void movement()
{
	...
	if ((var == 77 && dir != 75) || (var == 75 && dir != 77) || (var == 72 && dir != 80) || (var == 80 && dir != 72))
	{
		dir = var;
	}
	...
	/*if (var == 0 || var == 224)
	{
		...
		if (dir == 77)
		{
			...
			if (y == widthField - 1)		//pruchozi hrany
			{
				y = 0;
			}
		...
		if (dir == 80)
		{
			...
			if (x == heightField - 1)			//pruchozi hrany
			{
				x = 0;
			}
